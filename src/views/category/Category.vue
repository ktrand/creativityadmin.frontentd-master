...
<script>
import DataViewSidebar from '../../components/category/CategorySidebar'
...
export default {
  ...
  methods: {
    ...
    deleteData () {
      this.$store.dispatch('trends/DELETE_CATEGORY', this).catch(err => { console.error(err) })
    },
    editData (data) {
    ...
    deleteSelected() {
      ...
      if(this.selectedId.length > 0){
        this.$store.dispatch('trends/DELETE_SELECTED_CATEGORY', this).catch(err => { console.error(err) })
      }
    }
  },
